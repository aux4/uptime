...
```bash
aux4 uptime status [--name <name>] [--chart] [--period <daily|check>] [--days <n>] [--output <file>] [--theme <light|dark>] [--configFile <file>] [--db <file>] [--config <profile>]
```
